<template>
  <div class="slide__item">
    ...
    <div class="show__movieBox">
      <img class="movie__poster" :src="item.movie_poster" @click="showTime" alt="영화포스터">

      <div class="movie__timeList d-none">
        <video class="videoPreview" muted width="800" height="500" :src="`${item.preview }`" :poster="`${item.movie_poster }`" ref="preview"></video>
...
export default {
    ...
    methods:{
      ...
      async showTime() {
        ...
        const timeList = document.querySelector('.movie__timeList');
